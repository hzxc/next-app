...
const composeKey = (token0: ERC20Token, token1: ERC20Token) =>
...
export class Pair {
  ...
  public constructor(
    currencyAmountA: CurrencyAmount<ERC20Token>,
  ...
  public getOutputAmount(
    inputAmount: CurrencyAmount<ERC20Token>
  ): [CurrencyAmount<ERC20Token>, Pair] {
  ...
  public getInputAmount(
    outputAmount: CurrencyAmount<ERC20Token>
  ): [CurrencyAmount<ERC20Token>, Pair] {
