...
export const SettingsModal: React.FC<{
  ...
  return (
    <Modal visible={visible}>
      ...
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-h-screen overflow-hidden bg-white w-full min-w-[320px] rounded-[32px]'>
